...
call_id: 658351536    # this is the number shown in Fathom's URL bar
recording_id: 142774853    # internal API id, not shown in Fathom UI
project: Manufacturing Planning and JIT procurement agent
description: "Enterprise project planning: requirements gathering, module definition, workflow, client approval processes, data formats structured."
---# Enterprise Project Planning

*2026-05-01 — [Open in Fathom](https://fathom.video/calls/658351536)*
