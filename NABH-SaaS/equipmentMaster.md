---
title: Hospital Equipment Master
source: nabh_online_saas repo (src/data/equipmentMaster.ts)
imported: 2026-05-18
...
# Hospital Equipment Master

> Source: `src/data/equipmentMaster.ts` from `nabh.online-4th-feb` (NABH SaaS app — Supabase `aynoltymgusyasgxshng` is dead, pulling from local source). Live SaaS app: nabh.online
