---
title: RMO Doctors Master
source: nabh_online_saas repo (src/data/rmoDoctorsMaster.ts)
imported: 2026-05-18
...
> Source: `src/data/rmoDoctorsMaster.ts` from `nabh.online-4th-feb` (NABH SaaS app — Supabase `aynoltymgusyasgxshng` is dead, pulling from local source). Live SaaS app: nabh.online
