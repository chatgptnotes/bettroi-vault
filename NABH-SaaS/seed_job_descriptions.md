---
title: Job Descriptions (SQL seed)
source: nabh_online_saas repo (sql/seed_job_descriptions.sql)
imported: 2026-05-18
...
# Job Descriptions (SQL seed)

> Source: `sql/seed_job_descriptions.sql` from `nabh.online-4th-feb` (NABH SaaS app — Supabase `aynoltymgusyasgxshng` is dead, pulling from local source). Live SaaS app: nabh.online
