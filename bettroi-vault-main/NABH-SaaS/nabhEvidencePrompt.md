---
title: NABH Evidence Prompt (AI gen template)
source: nabh_online_saas repo (src/data/nabhEvidencePrompt.ts)
imported: 2026-05-18
...
# NABH Evidence Prompt (AI gen template)

> Source: `src/data/nabhEvidencePrompt.ts` from `nabh.online-4th-feb` (NABH SaaS app — Supabase `aynoltymgusyasgxshng` is dead, pulling from local source). Live SaaS app: nabh.online
