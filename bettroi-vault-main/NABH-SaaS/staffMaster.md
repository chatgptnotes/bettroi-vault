---
title: Hospital Staff Master
source: nabh_online_saas repo (src/data/staffMaster.ts)
imported: 2026-05-18
...
# Hospital Staff Master

> Source: `src/data/staffMaster.ts` from `nabh.online-4th-feb` (NABH SaaS app — Supabase `aynoltymgusyasgxshng` is dead, pulling from local source). Live SaaS app: nabh.online
